...
<div class="commercial-banner" style="background: #3ecdbb; background: -moz-linear-gradient(left, #3ecdbb 0%, #37b6bc 100%); background: -webkit-linear-gradient(left, #3ecdbb 0%,#37b6bc 100%); background: linear-gradient(to right, #3ecdbb 0%,#37b6bc 100%); color: #fff; padding: 20px; margin-left: -20px; font-size: 18px; line-height: 140%;">
	...
	<ul>
		...
		<a style="background-color: #fff; color: #6f6f6f; text-decoration: none; padding: 15px 30px; display: inline-block; border-radius: 3px; margin-top: 10px;" href="http://plugin-boutique.com/responsive-menu/" target="_blank">Buy now, it's only 10 dollars!</a>
...
<div class="responsivemenu-heading-inner">
	...
	function hmg_responsivemenu_header_customize() {
		...
		**************************************************************/
		/* widgets */
		.responsivemenu-widgets-wrapper .widgettitle { color:<?php  echo $hmg_responsivemenu_widget_title_color; ?>; }
		.responsivemenu-widgets-wrapper .widget { color:<?php  echo $hmg_responsivemenu_widget_text_color; ?>; }
		.responsivemenu-widgets-wrapper .post-date,
		.responsivemenu-widgets-wrapper .rss-date,
		.responsivemenu-widgets-wrapper .wp-caption,
		.responsivemenu-widgets-wrapper .wp-caption-text { color:<?php  echo $hmg_responsivemenu_widget_secondary_text_color; ?>; }
		.responsivemenu-widgets-wrapper .widget a { color:<?php  echo $hmg_responsivemenu_widget_link_color; ?>; }
		.responsivemenu-widgets-wrapper .widget_search input { color:<?php  echo $hmg_responsivemenu_widget_search_field_color; ?>; border-color:<?php  echo $hmg_responsivemenu_widget_search_border_color; ?>; }
		/* menu button */
		.responsivemenu-main-menu-button:after,
		.responsivemenu-main-menu-button:before,
		.responsivemenu-main-menu-button div.responsivemenu-main-menu-button-middle:before { background-color:<?php  echo $hmg_responsivemenu_menu_button_color; ?>; }
		/* main menu button hover */
		<?php  if ( wp_is_mobile() ) { ?>
			<?php  } else { ?>
				.responsivemenu-main-menu-button:hover:after,
				.responsivemenu-main-menu-button:hover:before,
				.responsivemenu-main-menu-button:hover div.responsivemenu-main-menu-button-middle:before { background-color:<?php  echo $hmg_responsivemenu_menu_button_hover_color; ?>; }
				<?php  } ?>
				/* menu button active */
				...
				.responsivemenu-menu-active .responsivemenu-main-menu-button div.responsivemenu-main-menu-button-middle:before { background-color:<?php  echo $hmg_responsivemenu_menu_button_active_color; ?>; }
				...
				<?php  if ( wp_is_mobile() ) { ?>
					<?php  } else { ?>
						...
						.responsivemenu-menu-active .responsivemenu-main-menu-button:hover div.responsivemenu-main-menu-button-middle:before { background-color:<?php  echo $hmg_responsivemenu_menu_button_active_hover_color; ?>; }
						<?php  } ?>
						/* secondary menu button */
						.responsivemenu-secondary-menu-button svg { fill:<?php  echo $hmg_responsivemenu_secondary_menu_button_color; ?>;}
						/* secondary menu button hover */
						<?php  if ( wp_is_mobile() ) { ?>
							<?php  } else { ?>
								.responsivemenu-secondary-menu-button svg:hover { fill:#A0A0A0; fill:<?php  echo $hmg_responsivemenu_secondary_menu_button_hover_color; ?>;}
								<?php  } ?>
								/* secondary menu button active */
								.responsivemenu-secondary-menu-button-active svg { fill:<?php  echo $hmg_responsivemenu_secondary_menu_button_active_color; ?>; }
								/* secondary menu button active hover */
								<?php  if ( wp_is_mobile() ) { ?>
									<?php  } else { ?>
										.responsivemenu-secondary-menu-button-active svg:hover { fill:<?php  echo $hmg_responsivemenu_secondary_menu_button_active_hover_color; ?>; }
										<?php  } ?>
										/* search button */
										.responsivemenu-search-button svg { fill:<?php  echo get_option('hmg_responsivemenu_search_button_color'); ?>; }
										.responsivemenu-search-button:hover svg { fill:<?php  echo get_option('hmg_responsivemenu_search_button_hover_color'); ?>; }
										/* search close button */
										.responsivemenu-search-close-button:before,
										.responsivemenu-search-close-button:after { background-color:<?php  echo get_option('hmg_responsivemenu_search_close_button_color'); ?>; }
										.responsivemenu-search-close-wrapper:hover .responsivemenu-search-close-button:before,
										.responsivemenu-search-close-wrapper:hover .responsivemenu-search-close-button:after { background-color:<?php  echo get_option('hmg_responsivemenu_search_close_button_hover_color'); ?>; }
										/* search field border + text */
										.responsivemenu-search-wrapper { border-color:<?php  echo get_option('hmg_responsivemenu_search_border_color'); ?>; }
										.responsivemenu-search-wrapper #searchform input { color:<?php  echo get_option('hmg_responsivemenu_search_text_color'); ?>; }
										/* heading + sub-heading text */
										.responsivemenu-heading-text { color:<?php  echo get_option('hmg_responsivemenu_heading_text_color'); ?>; }
										.responsivemenu-subheading-text { color:<?php  echo get_option('hmg_responsivemenu_subheading_text_color'); ?>; }
										/* heading overlay */
										.responsivemenu-heading-overlay { background-color:<?php  echo get_option('hmg_responsivemenu_heading_overlay_color'); ?>; }
										/* background overlay */
										.responsivemenu-background-overlay { background-color:<?php  echo get_option('hmg_responsivemenu_background_overlay_color'); ?>; }
										/* main menu */
										.responsivemenu-main-background { background-color:<?php  echo get_option('hmg_responsivemenu_main_menu_background_color'); ?>; }
										.responsivemenu-by-hmg ul li a { color:<?php  echo get_option('hmg_responsivemenu_main_menu_item_color'); ?>; }
										.responsivemenu-by-hmg ul li a:hover {color:<?php  echo get_option('hmg_responsivemenu_main_menu_item_hover_color'); ?>; }
										.responsivemenu-by-hmg ul.sub-menu li a { color:<?php  echo get_option('hmg_responsivemenu_main_menu_subitem_color'); ?>; }
										.responsivemenu-by-hmg ul.sub-menu li a:hover { color:<?php  echo get_option('hmg_responsivemenu_main_menu_subitem_hover_color'); ?>; }
										.responsivemenu-by-hmg .menu li span svg { fill:<?php  echo get_option('hmg_responsivemenu_main_menu_arrow_color'); ?>; }
										<?php  if ( wp_is_mobile() ) { ?>
											<?php  } else { ?>
												.responsivemenu-by-hmg .menu li span:hover svg { fill:#736F6C; fill:<?php  echo get_option('hmg_responsivemenu_main_menu_arrow_hover_color'); ?>; }
												<?php  } ?>
												.responsivemenu-by-hmg a i { color:<?php  echo get_option('hmg_responsivemenu_main_menu_icon_color'); ?>; }
												.responsivemenu-by-hmg a:hover i { color:<?php  echo get_option('hmg_responsivemenu_main_menu_icon_hover_color'); ?>; }
												.responsivemenu-by-hmg ul li.border a { border-color:<?php  echo get_option('hmg_responsivemenu_main_menu_border_color'); ?>; }
												/* secondary menu */
												.responsivemenu-secondary-menu-wrapper { background-color:<?php  echo get_option('hmg_responsivemenu_secondary_menu_background_color'); ?>; border-color:<?php  echo get_option('hmg_responsivemenu_secondary_menu_border_color'); ?>; }
												.responsivemenu-secondary-menu-wrapper:after { background-color:<?php  echo get_option('hmg_responsivemenu_secondary_menu_bottom_border_color'); ?>; }
												.responsivemenu-secondary-menu-wrapper a { color:<?php  echo get_option('hmg_responsivemenu_secondary_menu_item_color'); ?>; }
												.responsivemenu-secondary-menu-wrapper a:hover { color:<?php  echo get_option('hmg_responsivemenu_secondary_menu_item_hover_color'); ?>; }
												/* background overlay opacity */
												.responsivemenu-background-overlay-active { opacity:<?php  echo get_option('hmg_responsivemenu_background_overlay_opacity'); ?>; }
												/* menu button animations (-/X) */
												<?php  if(get_option('hmg_responsivemenu_button_animation') == "responsivemenuminusanimation") { ?>
													/* middle bar #1 animation (3 lines) */
													.responsivemenu-menu-active .responsivemenu-main-menu-button div.responsivemenu-main-menu-button-middle:before {
														margin:0 0 -1px 0;
													}
		...
		if(get_option('hmg_responsivemenu_button_animation') == "responsivemenuxanimation") {
			?>
														...
														<?php  } else { ?>
															...
															.responsivemenu-heading-image { height:<?php  echo get_option('hmg_responsivemenu_heading_height'); ?>px; }
															.responsivemenu-menu-wrapper { top:<?php  echo get_option('hmg_responsivemenu_heading_height'); ?>px; }
															/* heading overlay opacity */
															.responsivemenu-heading-overlay { opacity:<?php  echo get_option('hmg_responsivemenu_heading_overlay'); ?>; }
															/* heading image */
															.responsivemenu-heading-image {
																background-image:url(<?php  echo get_option('hmg_responsivemenu_heading_image'); ?>);
															}
															/* heading image pattern */
															<?php  if(get_option('hmg_responsivemenu_heading_image_pattern')) { ?>
																.responsivemenu-heading-image {
																	background-size:auto;
																}
																<?php  } ?>
																/* hide responsivemenu between resolutions */
																@media ( min-width:<?php  echo get_option('hmg_responsivemenu_smaller_than'); ?>px) and (max-width:<?php  echo get_option('hmg_responsivemenu_larger_than'); ?>px) {
